...
function sub_indiv_elect_cv_mRMR_LDA_OvR_data = indiv_electrode_cv_mRMR_LDA_OvR_rand(params_struct)
...
all_subs_indiv_elect_feat_table = params_struct.all_subs_indiv_elect_feat_table;
