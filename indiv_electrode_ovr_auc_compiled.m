...
sub_stim_e_id_auc_all_labels = addvars(sub_stim_e_id_auc_all_labels,...
    stim_table_row_col, stim_cluster_col, stim_roi_col,...
    'After', 'stim_e_id',...
    'NewVariableNames', {'stim_table_idx', 'stim_cluster', 'stim_roi'});
...
sub_onset_e_id_auc_all_labels = addvars(sub_onset_e_id_auc_all_labels,...
    onset_table_row_col, onset_cluster_col, onset_roi_col,...
    'After', 'onset_e_id',...
    'NewVariableNames', {'onset_table_idx', 'onset_cluster', 'onset_roi'});
