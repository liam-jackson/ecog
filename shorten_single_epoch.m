...
function shortened_epoch = shorten_single_epoch(epoch_data, alignment_condition, event_duration)
...
beg_idx = event_col - (num_event_samples / 2) + 1
end_idx = event_col + (num_event_samples / 2) 
