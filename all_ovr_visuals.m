...
for class_label_idx = 1:length(class_labels)
    ...
    %%%% class_label Figure
    class_label_auc_fig = figure('FileName', sprintf('all_ovr_%s.png',class_label)); 
    ...
    title('Mean AUCs of Classifiers Trained on All Individual Electrodes', 'FontSize', title_size);
