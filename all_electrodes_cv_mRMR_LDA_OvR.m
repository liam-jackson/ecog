...
function sub_cv_mRMR_LDA_OvR_data = all_electrodes_cv_mRMR_LDA_OvR(params_struct)
...
all_subs_feat_table = params_struct.all_subs_feat_table;
...
cv_mRMR_LDA_OvR_res_file = sprintf('e%s_w%s_s%s_sub_cv_mRMR_LDA_OvR_data', string(event_duration), string(window), string(stride));
cv_mRMR_LDA_OvR_res_filename_full = fullfile(mRMR_path, times_folder, class_label, cv_mRMR_LDA_OvR_res_file);
